function myRescale(X::Vector{Float64},Wk::Vector{Float64},metric::Vector{Float64},observed::Vector{Float64})
...
function cubicSplineInt(X::Vector{Float64},NewX::Vector{Float64}, Wk::Vector{Float64})
	...
	interp_cubic=Interpolations.extrapolate(Interpolations.scale(Interpolations.interpolate(Wk, Interpolations.BSpline(Interpolations.Cubic(Interpolations.Line(Interpolations.OnGrid())))), NewX), Interpolations.Line())
...
function cubicSplineDirect(X::Vector{Float64},NewX::Vector{Float64}, Wk::Vector{Float64})
	...
	interp_cubic=Dierckx.Spline1D(NewX, Wk, NewX[3:K2-2]; w=ones(K2), k=1, bc="nearest")#, s=0.00) #good with 11 points
